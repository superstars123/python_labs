...
class Player:
    ...
    def revive(self):
        ...
        self._health = 100
        self._alive = True
        print(f"{self._name} воскрешен")# from validate import check_name, check_health, check_level, check_exp
...
#         if not isinstance(other, Player):
#            return NotImplemented
#         return (self.level, self.experience) < (other.level, other.experience)
